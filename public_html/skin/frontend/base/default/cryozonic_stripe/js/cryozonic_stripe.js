...
var cryozonic = {
    ...
    getSourceOwner: function()
    {
        ...
        if (cryozonic.billingInfo !== null)
        {
            ...
            if (owner.address.postcode === null && cryozonic.billingInfo.postcode !== null)
    ...
    initStripeElements: function()
    {
		...
		var cardNumber = cryozonic.card = elements.create('payment', cryozonic.getStripeElementCardNumberOptions());
		...
		$('amscheckout-submit').onclick = function(el)
        {
			...
			cryozonic.stripeJsV3.confirmPayment({
			...
			cryozonic.stripeJsV3.confirmAfterpayClearpayPayment(
			  secret,
			  {
					return_url: 'https://www.noveistudio.com/checkout/onepage/success',
				},
			...
			cryozonic.stripeJsV3.confirmAffirmPayment (
			  secret,
			  {
					return_url: 'https://www.noveistudio.com/checkout/onepage/success',
				},
